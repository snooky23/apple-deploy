class IosDeployPlatform < Formula
  ...
  homepage "https://github.com/avilevin/ios-deploy-platform"
  url "https://github.com/avilevin/ios-deploy-platform/archive/refs/tags/v2.3.0.tar.gz"
  sha256 "PLACEHOLDER_SHA256" # Will be calculated when creating actual release
  license "MIT"
  version "2.3.0"
  ...
  def ios_deploy_script
    <<~EOS
      ...
      https://github.com/avilevin/ios-deploy-platform
      EOF
      }
  ...
  def man_page_content
    <<~EOS
      ...
      .SH REPORTING BUGS
      Report bugs to: https://github.com/avilevin/ios-deploy-platform/issues
  ...
  def caveats
    <<~EOS
      ...
      - GitHub: https://github.com/avilevin/ios-deploy-platform

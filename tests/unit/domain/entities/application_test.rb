...
class ApplicationTest
  ...
  def self.test_application_creation
    ...
    app = Application.new(
      bundle_identifier: "com.voiceforms.app",
      name: "Voice Forms",
    ...
    raise "Bundle identifier should be set" unless app.bundle_identifier == "com.voiceforms.app"
    ...
    raise "Team ID should be set" unless app.team_id == "NA5574MSN5"
  ...
  def self.test_bundle_identifier_validation
    ...
    app = Application.new(
      bundle_identifier: "com.voiceforms.myapp.extension",
      name: "Test App",
      display_name: "Test App", 
      scheme: "TestScheme",
      team_id: "ABC1234567",
    ...
    raise "Should extract correct domain" unless app.bundle_domain == "com.voiceforms.myapp"
    raise "Should extract correct app name" unless app.bundle_app_name == "extension"
    raise "Should recognize domain ownership" unless app.belongs_to_domain?("com.voiceforms")

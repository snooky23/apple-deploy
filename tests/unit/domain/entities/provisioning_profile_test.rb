...
class ProvisioningProfileTest
  ...
  def self.test_profile_creation
    ...
    raise "Profile app_identifier should be set" unless profile.app_identifier == "com.yourcompany.yourapp"
    raise "Profile team_id should be set" unless profile.team_id == "YOUR_TEAM_ID"
  ...
  def self.test_app_identifier_coverage
    ...
    # Test exact matching
    raise "Exact profile should cover exact match" unless exact_profile.covers_app_identifier?("com.yourcompany.yourapp")
    raise "Exact profile should not cover different app" if exact_profile.covers_app_identifier?("com.other.app")
    
    # Test wildcard matching
    raise "Wildcard profile should cover base app" unless wildcard_profile.covers_app_identifier?("com.yourcompany.yourapp")
    raise "Wildcard profile should cover child app" unless wildcard_profile.covers_app_identifier?("com.yourcompany.yourapp.extension")
  ...
  def self.test_business_rules
    ...
    base = ProvisioningProfile.base_identifier_from_wildcard("com.yourcompany.yourapp.*")
    raise "Should extract base from wildcard" unless base == "com.yourcompany.yourapp"
    
    non_wildcard = ProvisioningProfile.base_identifier_from_wildcard("com.yourcompany.yourapp.app")
    raise "Should return same for non-wildcard" unless non_wildcard == "com.yourcompany.yourapp.app"

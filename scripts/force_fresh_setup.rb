...
begin
  ...
  ENV['FASTLANE_USER'] = 'perchik.omer@gmail.com'
  ENV['FASTLANE_TEAM_ID'] = 'NA5574MSN5'
  
  # Create Development certificate
  FastlaneLogger.info("Creating Development certificate...")
  system('fastlane cert --development --output_path "./certificates/" --team_id NA5574MSN5 --api_key_path "./certificates/AuthKey_ZLDUP533YR.p8" --api_key ./certificates/AuthKey_ZLDUP533YR.p8 --key_id ZLDUP533YR --issuer_id 63cb40ec-3fb4-4e64-b8f9-1b10996adce6')
  
  # Create Distribution certificate  
  FastlaneLogger.info("Creating Distribution certificate...")
  system('fastlane cert --output_path "./certificates/" --team_id NA5574MSN5 --api_key_path "./certificates/AuthKey_ZLDUP533YR.p8" --api_key ./certificates/AuthKey_ZLDUP533YR.p8 --key_id ZLDUP533YR --issuer_id 63cb40ec-3fb4-4e64-b8f9-1b10996adce6')
  ...
  system('fastlane sigh --development --app_identifier com.voiceforms --output_path "./profiles/" --team_id NA5574MSN5 --force --api_key_path "./certificates/AuthKey_ZLDUP533YR.p8" --key_id ZLDUP533YR --issuer_id 63cb40ec-3fb4-4e64-b8f9-1b10996adce6')
  
  # Create Distribution profile
  FastlaneLogger.info("Creating Distribution provisioning profile...") 
  system('fastlane sigh --app_identifier com.voiceforms --output_path "./profiles/" --team_id NA5574MSN5 --force --api_key_path "./certificates/AuthKey_ZLDUP533YR.p8" --key_id ZLDUP533YR --issuer_id 63cb40ec-3fb4-4e64-b8f9-1b10996adce6')
